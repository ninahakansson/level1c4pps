...
"""Script to convert FIDUCEO level-1 to PPS level-1c format using Pytroll/Satpy."""

import argparse
from level1c4pps.fiduceo2pps_lib import process_one_scene
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description=('Script to produce a PPS-level1c file for a FIDUCEO level-1 scene'))
    parser.add_argument('files', metavar='fileN', type=str, nargs='+',
                        help='List of FIDUCEO files to process')
